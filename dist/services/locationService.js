...
exports.generateGoalLocation = void 0;
const turf = __importStar(require("@turf/turf"));
const generateGoalLocation = (locationData) => {
    ...
    const generatedGoalLocation = {
        lat: latitude,
        lng: longitude
    };
    return generatedGoalLocation;
};
exports.generateGoalLocation = generateGoalLocation;
